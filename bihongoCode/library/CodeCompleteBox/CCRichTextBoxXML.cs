...
namespace CodeCompletion_CSharp
{
    ...
    public class CCRichTextBoxXML : RichTextBox
    {
        ...
        public CCRichTextBoxXML()
        {
           // keywordUrl = "\\keywords\\c_sharp.xml";
            //*********************************************************************
        ...
        public void GetKeywordsListFromFile()
        {
                    ...
                    if (reader.IsStartElement())
                    {
                        switch (reader.Name.ToString())
                        {
                            ...
                            case "DataTypeKeyword":
                                datatypelist.Add(reader.ReadString());
                                break;
            ...
            this.DataTypesList = datatypelist;
        ...
        protected override void OnTextChanged(EventArgs e)
        {
            ...
            // remove CodeCompleteBox when text is null in this 
            // before remove check CodeCompleteBox is added to this or not
            if (this.Text == "")
            {
                if (isCodeCompleteBoxAdded)
                {
        ...
        protected override void OnKeyDown(KeyEventArgs e)
        {
            ...
            switch (e.KeyCode)
            {
                // if Space key is down then remove CodeCompleteBox control from this 
                case Keys.Space:
                    if (isCodeCompleteBoxAdded)
                    {
                        this.Controls.Remove(CodeCompleteBox);
                ...
                // if Enter key is down then remove CodeCompleteBox control from this 
                case Keys.Enter:
                    if (isCodeCompleteBoxAdded)
                    {
                        this.Controls.Remove(CodeCompleteBox);
                ...
                // if Escape key is down then remove CodeCompleteBox control from this 
                case Keys.Escape:
                    if (isCodeCompleteBoxAdded)
                    {
                        this.Controls.Remove(CodeCompleteBox);
                ...
                // if Back key is down then remove CodeCompleteBox control from this 
                case Keys.Back:
                    if (isCodeCompleteBoxAdded)
                    {
                        this.Controls.Remove(CodeCompleteBox);
        ...
        protected override void OnMouseClick(MouseEventArgs e)
        {
            ...
            // when mouse click on CCRichTextBox then remove CodeCompleteBox from this
        ...
        protected override void OnVScroll(EventArgs e)
        {
            ...
            // remove CodeCompleteBox when VScroll is changed in this
            // before remove check CodeCompleteBox is added to this or not
            if (isCodeCompleteBoxAdded)
            {
                this.Controls.Remove(CodeCompleteBox);
        ...
        private void CodeCompleteBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            // if pressed key is Back then set focus to this 
